...
export class DatabaseConnection {
  ...
  static async getInstance(): Promise<DatabaseConnection> {
    if (!DatabaseConnection.instance) {
      ...
      DatabaseConnection.instance.connectionManager =
        DatabaseConnection.instance.dataSource.manager;
    }
  ...
  public getConnectionManager(): EntityManager {
    ...
    throw new Error(
      "DataSource is not initialized. Please initialize the database connection first."
    );
  }
